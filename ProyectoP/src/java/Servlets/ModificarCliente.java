...
public class ModificarCliente extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String txtPagos = request.getParameter("pagos");
        ...
        out.println("<script type=\"text/javascript\">");
              ...
              boolean registro = metodo.modificarCliente(txtCodigo,txtEmail,txtDireccion,txtCelular,txtTelefono,txtPagos);
            if (registro == true) {
                out.println("alert('Usuario Modificado en forma exitosa')");
                out.println("location= 'Mantenimiento.jsp'");
            } else {
                out.println("alert('Error: Usuario no Modificado')");
                out.println("location= 'Mantenimiento.jsp'");
            }
